...
int main(int argc, char* argv[])
{
    ...
    }   else if(strcmp(argv[1],"-m3")==0)
    {
        ...
        if(nodesPerLevel==1)
            cout << "----------------------------------------------------------------" << endl << "Algorytm z asymptota O(T(n))=n^2" << endl << "----------------------------------------------------------------" << endl;
        else if(type==1)
            cout << "----------------------------------------------------------------" << endl << "Algorytm z asymptota O(T(n))=" << nodesPerLevel << "^[(n-1)/" << nodesPerLevel+1 << "]" << endl << "----------------------------------------------------------------" << endl;
        else
            cout << "----------------------------------------------------------------" << endl << "Algorytm z asymptota O(T(n))=" << nodesPerLevel << "^[(n-2)/" << nodesPerLevel << "]" << endl << "----------------------------------------------------------------" << endl;

        cout << left << "|" << setw(20) << "n" << "|" << setw(20) << "t(n)[ms]" << "|" << setw(20) << "q" << "|" << endl << "----------------------------------------------------------------" << endl;
        for(int i=0;i<k;i++)
        {
            for(int j=0;j<r;j++)
            {
